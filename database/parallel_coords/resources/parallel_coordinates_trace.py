...
extractSubset1Display.SeriesVisibility = ['temperature', 'temperature anomaly', 'thermal conductivity', 'thermal expansivity']      # OWN_DATA: change field names
...
temperatureLUTColorBar.Title = 'temperature'                        # OWN_DATA: change title according to field
...
thermalconductivityLUTColorBar.Title = 'thermal conductivity'               # OWN_DATA: change title according to field
...
temperatureanomalyLUTColorBar.Title = 'temperature anomaly'                     # OWN_DATA: change title according to field
...
thermalexpansivityLUTColorBar.Title = 'thermal expansivity'                     # OWN_DATA: change title according to field
